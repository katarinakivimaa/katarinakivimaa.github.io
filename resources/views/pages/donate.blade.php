...
@section('content')
<div class="min-h-screen pt-32 flex justify-center items-start font-primary px-8">
  <div class="flex max-w-6xl w-full gap-16">

    <div class="flex-shrink-0">
      <img src="/windmill_banner" class="max-w-xs" />
    </div>
